...
namespace Lab_Assign_2
{
    ...
    public class BasePlusCommissionEmployee :CommissionEmployee //Inheriting CommissionEmployee class
    {
        private decimal baseSalary; // base salary per week

        // six-parameter constructor
        public BasePlusCommissionEmployee(string first, string last,
           string ssn, decimal sales, decimal rate, decimal salary):base(first,last,ssn,sales,rate)  //changes
        {
        ...
        public override decimal GetPaymentAmount() //Changes
        
        {
            return BaseSalary + base.GetPaymentAmount(); //Changes
        } // end method Earnings               
